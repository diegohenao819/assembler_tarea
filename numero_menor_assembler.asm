...
result: .asciiz "El número menor es: " # Mensaje para mostrar resultado
...
main:
    ...
    li $t0, 2147483647          # Almacena el número menor, inicializa con el máximo valor para int
...
input_loop:
    ...
    # Comparar y guardar si es menor
    bge $t2, $t0, skip         # Si $t2 >= $t0, salta a skip
...
skip:
    ...
    move $a0, $t0              # mueve el número menor a $a0
    li $v0, 1                  # syscall para print int
    syscall                    # imprime el número menor
